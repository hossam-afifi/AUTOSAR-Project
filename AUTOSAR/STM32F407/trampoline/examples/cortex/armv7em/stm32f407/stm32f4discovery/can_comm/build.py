...
includeDirs += ["-I", "blink"]
if comm_stack:
  includeDirs += ["-I", "../../../../../../commstack/can"]
if comm_stack:
  includeDirs += ["-I", "../../../../../../commstack/canif"]
if comm_stack:
  includeDirs += ["-I", "../../../../../../commstack/cantp"]
if comm_stack:
  includeDirs += ["-I", "../../../../../../commstack/pdur"]
if comm_stack:
  includeDirs += ["-I", "../../../../../../commstack/include"]
cflags   += includeDirs
...
cSourceList.append(projfile.ProjectFile("helper.c"))
...
cSourceList.append(projfile.ProjectFile("commstack/can/Can.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("commstack/canif/CanIf.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("commstack/cantp/CanTp.c", trampoline_base_path))
...
cSourceList.append(projfile.ProjectFile("machines/cortex/armv7em/stm32f407/STM32F4xx_StdPeriph_Driver/stm32f4xx_can.c", trampoline_base_path))
...
if True:
  postCommand = makefile.PostCommand("Generating binary can_blinky.bin from can_blinky")
  postCommand.mCommand.append(r"arm-none-eabi-objcopy")
  postCommand.mCommand += "-O binary".split()
  postCommand.mCommand.append("can_blinky")
  postCommand.mCommand.append("can_blinky.bin")
...
if make.errorCount() == 0:
  if askedGoal == "burn" :
    ...
    if makefile.find_executable("st-flash") != None:
      print("\033[1m\033[95mFlashing can_blinky on cortex/armv7em/stm32f407/stm32f4discovery\033[0m")
