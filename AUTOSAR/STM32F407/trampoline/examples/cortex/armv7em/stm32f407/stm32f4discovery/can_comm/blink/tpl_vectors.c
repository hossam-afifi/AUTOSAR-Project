...
extern FUNC(void, OS_CODE) tpl_primary_irq_handler_CAN1_TX_IRQ(P2CONST(void, OS_APPL_DATA, AUTOMATIC));
extern FUNC(void, OS_CODE) tpl_primary_irq_handler_CAN1_RX0_IRQ(P2CONST(void, OS_APPL_DATA, AUTOMATIC));
extern FUNC(void, OS_CODE) tpl_primary_irq_handler_CAN1_RX1_IRQ(P2CONST(void, OS_APPL_DATA, AUTOMATIC));
extern FUNC(void, OS_CODE) tpl_primary_irq_handler_CAN1_SCE_IRQ(P2CONST(void, OS_APPL_DATA, AUTOMATIC));
...
__attribute__ ((section(".isr_vector"))) CONST(tpl_it_handler, AUTOMATIC) tpl_it_vectors[98] = {
  ...
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_primary_irq_handler_CAN1_TX_IRQ,
  (tpl_it_handler)tpl_primary_irq_handler_CAN1_RX0_IRQ,
  (tpl_it_handler)tpl_primary_irq_handler_CAN1_RX1_IRQ,
  (tpl_it_handler)tpl_primary_irq_handler_CAN1_SCE_IRQ,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
